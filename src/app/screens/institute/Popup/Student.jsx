...
const Student = ({setUser}) => {
  ...
  return (
    <>
    <div className="flex h-screen relative w-2/2 items-center bg-slate-200 flex-col justify-center ml-[10rem] ">
    ...
    <span className="font-bold w-1/4 flex justify-center items-center">Email</span>
